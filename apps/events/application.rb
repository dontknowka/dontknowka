...
require_relative './controllers/verification'
...
module Events
  class Application < Hanami::Application
    configure do
      ...
      #
      # sessions :cookie, secret: ENV['EVENTS_SESSIONS_SECRET']
      ...
      #
      layout :application # It will load Events::Views::ApplicationLayout
      ...
      # Configure the code that will yield each time Events::Action is included
      ...
      controller.prepare do
        ...
        include Events::Verification
      end

      # Configure the code that will yield each time Events::View is included
      # This is useful for sharing common functionality
      #
      # See: http://www.rubydoc.info/gems/hanami-view#Configuration
      view.prepare do
        include Hanami::Helpers
        include Events::Assets::Helpers
      end
    end
